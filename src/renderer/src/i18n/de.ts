...
export const de = {
  ...
  'settings.storage.hint': 'Thumbnails und API-Antworten bleiben während der App-Sitzung gecacht. Maximale Cache-Größe: 512 MB.',
  'settings.hlsCache.label': 'HLS-Cache',
  'settings.hlsCache.on': 'Aktiv — empfohlen für störungsfreie Wiedergabe und schnelles Seeking',
  'settings.hlsCache.off': 'Inaktiv — kann Puffern und langsameres Seeking verursachen',
