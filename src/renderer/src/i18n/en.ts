...
export const en: Messages = {
  ...
  'settings.storage.hint': 'Thumbnails and API responses remain cached during the app session. Maximum cache size: 512 MB.',
  'settings.hlsCache.label': 'HLS cache',
  'settings.hlsCache.on': 'Active — recommended for smooth playback and fast seeking',
  'settings.hlsCache.off': 'Inactive — may cause buffering and slower seeking',
